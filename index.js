                            ...
                            if(obj.asset) {
                                if(obj.asset.data) {
                                    if(obj.asset.data.time) {
                                        let from = obj.inputs[0].owners_before[0]
                                        let to = obj.outputs[0].public_keys[0]
                                        let amount = obj.outputs[0].amount
                                        let time = obj.asset.data.time
                                        numTrans += 1;
                                        console.log(from, to, amount, time)
                                    }
                                }
                            }
                        }
